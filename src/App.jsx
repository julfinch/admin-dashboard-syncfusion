...
import { Ecommerce,Analytics, Orders,Messages, Calendar, Employees, Stacked, Pyramid, Customers, Kanban, Line, Area, Bar, Pie, Financial, ColorPicker, ColorMapping, Editor } from './pages';
import './App.css';
    ...
    <div className={currentMode === 'Dark' ? 'dark' : ''} >
      <BrowserRouter>
        <div className="flex bg-page-pattern bg-cover relative dark:bg-main-dark-bg">
          ...
          >
            <div className="fixed md:static bg-white shadow-sm dark:bg-secondary-dark-bg navbar w-full ">
              <Navbar />
            </div>
            <div>
